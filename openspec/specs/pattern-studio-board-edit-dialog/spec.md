...
The board edit dialog SHALL expose the same single-board editing entry point and update behavior as the normal board inspector flow.

#### Scenario: Edit board in dialog
- **WHEN** the user edits a board through the dialog flow
